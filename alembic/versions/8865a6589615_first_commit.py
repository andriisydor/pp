...
Revision ID: 8865a6589615
Revises: 
Create Date: 2021-11-09 15:46:17.802633
...
def upgrade():
    ...
    sa.Column('singer', sa.VARCHAR(length=200), nullable=True),
    sa.Column('album', sa.VARCHAR(length=200), nullable=True),
    sa.Column('duration', sa.VARCHAR(length=200), nullable=False),
